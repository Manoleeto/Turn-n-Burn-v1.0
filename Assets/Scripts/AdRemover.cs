...
public class AdRemover : MonoBehaviour, IStoreListener
{
    ...
    public string kAppleNoAdsProductID = "com.unity3d.test.services.purchasing.nonconsumable";      // Apple App Store identifier for the non-consumable product.     
    public string kGooglePlayNoAdsProductID = "no_ads";     // Google Play Store identifier for the non-consumable product.   

    public GameObject objectToDisableWhenAdsAreSuccesfullyRemoved;


    public static AdRemover instance;
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(kProductIDNonConsumable, ProductType.NonConsumable, new IDs() { { kAppleNoAdsProductID, AppleAppStore.Name }, { kGooglePlayNoAdsProductID, GooglePlay.Name }, });// And finish adding the subscription product.
    ...
    void disableAds()
    {
        objectToDisableWhenAdsAreSuccesfullyRemoved.SetActive(false);
        saveToPlayerPrefs();
    }
